...
public class ACTUALIZAR_CURSOS extends JFrame implements ActionListener {
    ...
    public ACTUALIZAR_CURSOS() {
        ...
        //ETIQUETAS
        l5 = new JLabel("Actualizar datos curso");
        l5.setBounds(30, 15, 300, 25);
        l5.setVisible(true);
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == b1){
          ...
          int creditos = Integer.parseInt(t3.getText());
           ...
           PROYECTO1.Actualizarc(codigo,nombre,creditos,opcion);
