...
public class CREARC extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == b1){
            ...
            Cursos1 nuevo = new Cursos1(codigo,nombre,creditos,0,opcion);   
            PROYECTO1.AgregarCursos(nuevo);

            JOptionPane.showMessageDialog(this, "Se agrego el curso");
